    ...
    <div class="row align-items-center justify-content-center">
      <div class="col col-12 col-sm-10 col-md-10">
        <div class="card-group">
          <div class="card">
            <img :src="require('@/assets/customer.jpg')" alt="" class="card-img-top" style="height: 15rem">
            <div class="card-body">
          ...
          <div class="card">
            <img :src="require('@/assets/nonstock.jpg')" alt="" class="card-img-top" style="height: 15rem">
            <div class="card-body">
          ...
          <div class="card">
            <img :src="require('@/assets/stocks.jpg')" alt="" class="card-img-top" style="height: 15rem">
            <div class="card-body">
